...
import { Home, Sparkles, Calendar as CalendarIcon, List, Scale, LogOut, UserCircle } from 'lucide-react';
...
const Header: React.FC<HeaderProps> = ({ onGenerate, onBalance, isGenerating, viewMode, setViewMode, userName, onSignOut }) => {
  return (
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center h-auto sm:h-16 py-3 sm:py-0 space-y-3 sm:space-y-0">
          ...
          <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
            ...
            <div className="flex items-center ml-2 pl-2 border-l border-slate-200">
              ...
              <button
                onClick={onSignOut}
                className="flex items-center p-2 rounded-lg text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors"
                title="Sign out"
              >
                <LogOut size={16} />
              </button>
